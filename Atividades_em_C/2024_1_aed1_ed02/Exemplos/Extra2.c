...
OBS: O mesmo codigo utilizado no extra1 poderá ser utilizado no extra2 devido ao else que já faz a função
de indicar os caracteres que não estarão entre os demais
